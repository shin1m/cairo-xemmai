...
void t_type_of<t_matrix>::f_construct(t_object* a_class, size_t a_n, t_stack& a_stack)
{
...
void t_type_of<t_matrix>::f_instantiate(t_object* a_class, size_t a_n, t_stack& a_stack)
{
