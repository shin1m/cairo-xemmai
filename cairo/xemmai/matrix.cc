...
t_scoped t_type_of<t_matrix>::f_construct(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
	return t_overload<
...
void t_type_of<t_matrix>::f_instantiate(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
