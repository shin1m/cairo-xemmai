...
void t_type_of<t_font_face>::f_construct(t_object* a_class, size_t a_n, t_stack& a_stack)
{
	t_throwable::f_throw(L"uninstantiatable.");
}

void t_type_of<t_font_face>::f_instantiate(t_object* a_class, size_t a_n, t_stack& a_stack)
{
...
void t_type_of<t_toy_font_face>::f_construct(t_object* a_class, size_t a_n, t_stack& a_stack)
{
	t_construct_with<t_transfer (*)(t_object*, const std::wstring&, cairo_font_slant_t, cairo_font_weight_t), t_toy_font_face::f_construct>::f_call(a_class, a_n, a_stack);
}
