...
t_scoped t_type_of<cairo::xemmai::t_context>::f_construct(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
	return t_construct_with<t_scoped (*)(t_object*, t_surface&), t_context::f_construct>::t_bind<t_context>::f_do(a_class, a_stack, a_n);
}

void t_type_of<cairo::xemmai::t_context>::f_instantiate(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
