...
void t_type_of<t_pattern>::f_construct(t_object* a_class, size_t a_n)
{
	t_throwable::f_throw(L"uninstantiatable.");
}

void t_type_of<t_pattern>::f_instantiate(t_object* a_class, size_t a_n)
{
...
void t_type_of<t_solid_pattern>::f_construct(t_object* a_class, size_t a_n)
{
...
void t_type_of<t_surface_pattern>::f_construct(t_object* a_class, size_t a_n)
{
	t_construct_with<t_transfer (*)(t_object*, t_surface&), t_surface_pattern::f_construct>::f_call(a_class, a_n);
}
...
void t_type_of<t_linear_gradient>::f_construct(t_object* a_class, size_t a_n)
{
	t_construct_with<t_transfer (*)(t_object*, double, double, double, double), t_linear_gradient::f_construct>::f_call(a_class, a_n);
}
...
void t_type_of<t_radial_gradient>::f_construct(t_object* a_class, size_t a_n)
{
	t_construct_with<t_transfer (*)(t_object*, double, double, double, double, double, double), t_radial_gradient::f_construct>::f_call(a_class, a_n);
}
