...
void t_type_of<xemmaix::cairo::t_scaled_font>::f_define(t_extension* a_extension)
{
	...
	t_define<t_scaled_font, t_object>(a_extension, L"ScaledFont"sv)
		...
		(L"font_extents"sv, t_member<t_scoped(t_scaled_font::*)() const, &t_scaled_font::f_font_extents>())
		(L"text_extents"sv, t_member<t_scoped(t_scaled_font::*)(std::wstring_view) const, &t_scaled_font::f_text_extents>())
		//(L"glyph_extents"sv, t_member<t_scoped(t_scaled_font::*)(const cairo_glyph_t*, int) const, &t_scaled_font::f_glyph_extents>())
		...
		(L"get_font_options"sv, t_member<t_scoped(t_scaled_font::*)() const, &t_scaled_font::f_get_font_options>())
...
t_scoped t_type_of<xemmaix::cairo::t_scaled_font>::f_do_construct(t_stacked* a_stack, size_t a_n)
{
