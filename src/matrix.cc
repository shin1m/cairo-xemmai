...
t_type* t_type_of<xemmaix::cairo::t_matrix>::f_derive(t_object* a_this)
{
	return nullptr;
}
...
t_scoped t_type_of<xemmaix::cairo::t_matrix>::f_construct(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
	return t_overload<
		t_construct<double, double, double, double, double, double>,
		t_construct<>
	>::t_bind<xemmaix::cairo::t_matrix>::f_do(a_class, a_stack, a_n);
}

void t_type_of<xemmaix::cairo::t_matrix>::f_instantiate(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
