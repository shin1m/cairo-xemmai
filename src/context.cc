...
void t_type_of<xemmaix::cairo::t_context>::f_define(t_extension* a_extension)
{
	...
	t_define<t_context, t_object>(a_extension, L"Context"sv)
		...
		(L"clip_extents"sv, t_member<t_pvalue(t_context::*)() const, &t_context::f_clip_extents>())
		...
		(L"fill_extents"sv, t_member<t_pvalue(t_context::*)() const, &t_context::f_fill_extents>())
		...
		(L"storke_extents"sv, t_member<t_pvalue(t_context::*)() const, &t_context::f_stroke_extents>())
		...
		(L"get_current_point"sv, t_member<t_pvalue(t_context::*)() const, &t_context::f_get_current_point>())
		...
		(L"path_extents"sv, t_member<t_pvalue(t_context::*)() const, &t_context::f_path_extents>())
		...
		(L"user_to_device"sv, t_member<t_pvalue(t_context::*)(double, double) const, &t_context::f_user_to_device>())
		(L"user_to_device_distance"sv, t_member<t_pvalue(t_context::*)(double, double) const, &t_context::f_user_to_device_distance>())
		(L"device_to_user"sv, t_member<t_pvalue(t_context::*)(double, double) const, &t_context::f_device_to_user>())
		(L"device_to_user_distance"sv, t_member<t_pvalue(t_context::*)(double, double) const, &t_context::f_device_to_user_distance>())
		...
		(L"get_font_options"sv, t_member<t_pvalue(t_context::*)() const, &t_context::f_get_font_options>())
