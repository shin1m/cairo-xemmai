...
t_type* t_type_of<xemmaix::cairo::t_context>::f_derive()
{
	return nullptr;
}
...
t_scoped t_type_of<xemmaix::cairo::t_context>::f_construct(t_stacked* a_stack, size_t a_n)
{
...
void t_type_of<xemmaix::cairo::t_context>::f_instantiate(t_stacked* a_stack, size_t a_n)
{
