...
t_type* t_type_of<xemmaix::cairo::t_context>::f_derive(t_object* a_this)
{
	return nullptr;
}

void t_type_of<xemmaix::cairo::t_context>::f_finalize(t_object* a_this)
{
	auto p = static_cast<xemmaix::cairo::t_context*>(a_this->f_pointer());
	assert(!*p);
	delete p;
}

t_scoped t_type_of<xemmaix::cairo::t_context>::f_construct(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
	return t_construct_with<t_scoped(*)(t_object*, xemmaix::cairo::t_surface&), xemmaix::cairo::t_context::f_construct>::t_bind<xemmaix::cairo::t_context>::f_do(a_class, a_stack, a_n);
}

void t_type_of<xemmaix::cairo::t_context>::f_instantiate(t_object* a_class, t_stacked* a_stack, size_t a_n)
{
...
{
	t_define<cairo_fill_rule_t, intptr_t>(a_extension, L"FillRule")
...
{
	t_define<cairo_line_cap_t, intptr_t>(a_extension, L"LineCap")
...
{
	t_define<cairo_line_join_t, intptr_t>(a_extension, L"LineJoin")
...
{
	t_define<cairo_operator_t, intptr_t>(a_extension, L"Operator")
